...
class Manager
{
     ...
     * @param Link[] $productLinksPurchased
     */
    public function __construct(
        ...
        private array $productLinksPurchased = []
    ) {
    }
...
//    }
    ...
    {
        if (!empty($this->productLinksPurchased)) {
            return $this->productLinksPurchased;
        }
        ...
        foreach ($linkPurchasedItemCollection as $linkPurchasedItem) {
            ...
            $this->productLinksPurchased[$linkPurchasedItem->getLinkId()] = $link;
        }
    ...
    public function getLinkPurchasedCollectionWhereLinkMissed(Link $link): LinkPurchasedCollection
    {
        ...
        $linkPurchasedItemJoinCondition = [
            ...
            $linkPurchasedItemTableName . '.link_id = ' . $link->getId()
        ];

        $linkPurchasedCollection = $this->createLinkPurchasedCollection();

        $linkPurchasedCollection->getSelect()->joinLeft($linkPurchasedItemTableName,
            implode(' AND ', $linkPurchasedItemJoinCondition),
            []
        )->where(new \Zend_Db_Expr($linkPurchasedItemTableName . '.link_id IS NULL'));
